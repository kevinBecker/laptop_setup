...
" jump up or down to a line, by {count}k to go up or {count}j for down
set relativenumber
...
" Search is case insensitive when all lowecase
set ignorecase

" Search is case sensitive when a letter is uppercase
set smartcase
